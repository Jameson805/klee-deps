...
make clean
make $1
$LEVEL/build/bin/opt -enable-new-pm=0 $MEM2REG -instnamer $1 -o $1
# $LEVEL/Debug+Asserts/bin/opt -inline -inline-threshold=500 $1 -o $1
$LEVEL/build/bin/llvm-dis $1 -o $1-$COL".ll"
...
$LEVEL/build/bin/opt \
  ...
  -vulnerablebranchwrapper -enable-new-pm=0 -opaque-pointers=0 -maxcxt=$5 < $1 2> tmp.dat > svf-out.dat
