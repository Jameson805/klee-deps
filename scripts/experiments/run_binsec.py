        ...
        for benchmark in benchmarks:
            ...
            for index, raw_case in enumerate(expect_array(raw_cases, f"{benchmark_definition.config_location}.binsec_cases")):
                ...
                run_case(
                    ...
                    str(resolve_repo_path(expect_string(case_table, "sse_script", f"{benchmark_definition.config_location}.binsec_cases[{index}]"))),
...
def run_case(
    ...
    *converter_args: str,
    ...
    executable_path = resolve_repo_path(executable)
    context.log("=========")
    context.log(title)
    context.log("=========")
    context.run(
    ...
    code_path = str(resolve_repo_path(benchmark_definition.code_path))
