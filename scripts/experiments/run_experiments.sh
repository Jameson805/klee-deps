...
apply_sliced_map_module="tools.converters.apply_sliced_map"
...
sliced_map_csv="$repo_root/configs/binsec/sliced_map.csv"
filtered_locations_csv="$repo_root/configs/binsec/filtered_locations.csv"
run_time="4h"
