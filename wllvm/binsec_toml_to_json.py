...
def main(argv: List[str]) -> int:
    ...
    p.add_argument(
        "--toml",
        required=True,
        help="Path to BINSEC stats TOML (e.g., wllvm/binsec_results/libgcrypt_fix_pub.toml)",
    )
    p.add_argument(
        "--output-log",
        required=True,
        help="Path to shared console output log (e.g., wllvm/binsec_results/output.log)",
    )
    p.add_argument(
        "--executable",
        required=True,
        help="Path to the analyzed BINSEC executable (used for addr->source) (e.g., wllvm/libgcrypt-and-libgpg-error/binsec_fix_pub)",
    )
    p.add_argument(
        "--sym-size",
        type=int,
    ...
    p.add_argument(
        "--replay-executable",
        default=None,
        help="Path to the REPLAY executable used by reproduce_positives.py (e.g., wllvm/libgcrypt-and-libgpg-error/klee_fix_pub_replay).",
    )
    p.add_argument(
        "--reproduce",
        action="store_true",
