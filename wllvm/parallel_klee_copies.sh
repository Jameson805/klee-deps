...
Example:
  parallel_klee_copies.sh 3 wllvm/klee_cf_results output -- ./wllvm/run_klee_cf.sh
  parallel_klee_copies.sh --tmp-dir /var/tmp 3 wllvm/klee_cf_results output -- ./wllvm/run_klee_cf.sh
  parallel_klee_copies.sh --clean-destination 3 wllvm/klee_cf_results output -- ./wllvm/run_klee_cf.sh
