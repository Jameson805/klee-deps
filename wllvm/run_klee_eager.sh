...
script_path=$(realpath ../klee-eager/scripts)
...
results_dir="klee_eager_results"
rm -rf "$results_dir"
mkdir -p "$results_dir"
...
run_mbedtls_sliced() {
    ...
    limit_loop \
        -blacklist=bitlen_i64_nosign,mbedtls_mpi_bitlen,mbedtls_clz \
        -o mbedtls-3.2.1/klee_fix_pub_sliced_lim_loop.bc \
        mbedtls-3.2.1/klee_fix_pub_sliced.bc
    limit_loop \
        -blacklist=bitlen_i64_nosign \
        -break \
        -o mbedtls-3.2.1/klee_fix_pub_sliced_lim_loop_break.bc \
        mbedtls-3.2.1/klee_fix_pub_sliced.bc
    limit_loop \
        -blacklist=bitlen_i64_nosign,mbedtls_mpi_bitlen,mbedtls_clz \
        -o mbedtls-3.2.1/klee_var_pub_sliced_lim_loop.bc \
...
run_openssl() {
    ...
    run_openssl_algo() {
        ...
        run_case "OpenSSL 1.1.1q ${algo} (Fix Pub)" "openssl-1.1.1q/klee_fix_pub_${algo}.bc" "openssl_${algo}_fix_pub" "openssl-1.1.1q/klee_fix_pub_replay_${algo}" "--secret exp" "../ctchecker_results/openSSL_1_1_1q/${algo}-3.json" "openssl-1.1.1q" "$memory_flag" --ctchecker-prefix "crypto/bn"
        # run_case "OpenSSL 1.1.1q ${algo} (Fix Pub Lim Loop)" "openssl-1.1.1q/klee_fix_pub_lim_loop_${algo}.bc" "openssl_${algo}_fix_pub_lim_loop" "openssl-1.1.1q/klee_fix_pub_replay_${algo}" "--secret exp" "../ctchecker_results/openSSL_1_1_1q/${algo}-3.json" "openssl-1.1.1q" "$memory_flag" --ctchecker-prefix "crypto/bn"
        # run_case "OpenSSL 1.1.1q ${algo} (Fix Pub Lim Loop Break)" "openssl-1.1.1q/klee_fix_pub_lim_loop_break_${algo}.bc" "openssl_${algo}_fix_pub_lim_loop_break" "openssl-1.1.1q/klee_fix_pub_replay_${algo}" "--secret exp" "../ctchecker_results/openSSL_1_1_1q/${algo}-3.json" "openssl-1.1.1q" "$memory_flag" --ctchecker-prefix "crypto/bn"
        run_case "OpenSSL 1.1.1q ${algo} (Var Pub)" "openssl-1.1.1q/klee_var_pub_${algo}.bc" "openssl_${algo}_var_pub" "openssl-1.1.1q/klee_var_pub_replay_${algo}" "--secret exp --public base,mod" "../ctchecker_results/openSSL_1_1_1q/${algo}-3.json" "openssl-1.1.1q" "$memory_flag" --ctchecker-prefix "crypto/bn"
        # run_case "OpenSSL 1.1.1q ${algo} (Var Pub Lim Loop)" "openssl-1.1.1q/klee_var_pub_lim_loop_${algo}.bc" "openssl_${algo}_var_pub_lim_loop" "openssl-1.1.1q/klee_var_pub_replay_${algo}" "--secret exp --public base,mod" "../ctchecker_results/openSSL_1_1_1q/${algo}-3.json" "openssl-1.1.1q" "$memory_flag" --ctchecker-prefix "crypto/bn"
        run_case "OpenSSL 1.1.1q ${algo} (Var Pub Lim Loop Break)" "openssl-1.1.1q/klee_var_pub_lim_loop_break_${algo}.bc" "openssl_${algo}_var_pub_lim_loop_break" "openssl-1.1.1q/klee_var_pub_replay_${algo}" "--secret exp --public base,mod" "../ctchecker_results/openSSL_1_1_1q/${algo}-3.json" "openssl-1.1.1q" "$memory_flag" --ctchecker-prefix "crypto/bn"
    }
