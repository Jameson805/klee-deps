...
rm -f libgcrypt-and-libgpg-error/klee-last
rm -rf libgcrypt-and-libgpg-error/klee-out-*
compare_with_ctchecker.py ../ctchecker_results/libgcrypt1.10.1/2.json results/libgcrypt_fix_pub_lim_loop results/libgcrypt_fix_pub_lim_loop_combined.json --code-path libgcrypt-and-libgpg-error/libgcrypt-1.10.1/src
...
rm -f libgcrypt-and-libgpg-error/klee-last
rm -rf libgcrypt-and-libgpg-error/klee-out-*
compare_with_ctchecker.py ../ctchecker_results/libgcrypt1.10.1/2.json results/libgcrypt_var_pub_lim_loop results/libgcrypt_var_pub_lim_loop_combined.json --code-path libgcrypt-and-libgpg-error/libgcrypt-1.10.1/src
